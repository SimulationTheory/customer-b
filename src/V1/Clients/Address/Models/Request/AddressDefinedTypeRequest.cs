...
namespace PSE.Customer.V1.Clients.Address.Models.Request
{
    /// <summary>
    /// Request Object For Sap Format Conversion
    /// </summary>
    ...
    public class AddressDefinedTypeRequest : AddressDefinedType, IAPIRequest
    {
        /// <summary>
